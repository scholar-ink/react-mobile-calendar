...
var MultiMonthView = function (_Component) {
  ...
  function MultiMonthView(props) {
    ...
    var _this$props = _this.props,
        ...
        endMoment = _this$props.endMoment;


    _this.startMoment = startMoment;

    _this.endMoment = endMoment;
  ...
  (0, _createClass3.default)(MultiMonthView, [{
    key: 'doMap',
    value: function doMap(rangeDays) {
      var _this2 = this;
    ...
    value: function renderMonth(month, monthIndex) {
      return _react2.default.createElement(
        ...
        this.props.isShowWeek ? _react2.default.createElement(_WeekDay2.default, null) : '',
